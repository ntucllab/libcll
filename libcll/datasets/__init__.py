...
def prepare_dataloader(
    ...
    train_loader = DataLoader(train_set, sampler=train_sampler, batch_size=batch_size, collate_fn=collate_fn_one_hot if one_hot else collate_fn_multi_label, shuffle=False, num_workers=4)
    valid_loader = DataLoader(train_set, sampler=valid_sampler, batch_size=batch_size, collate_fn=collate_fn_multi_label, shuffle=False, num_workers=4)
    ...
    return train_loader, valid_loader, test_loader, train_set.input_dim, train_set.num_classes, Q, class_priors